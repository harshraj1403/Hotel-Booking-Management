...
import com.example.Hotel.Bookings.Management.System.services.RoomService;
...
//    private static final String IMAGE_DIRECTORY_FRONTEND = "C:/Users/krishnasai.chinthapu/Desktop/Hotel-Bookings-Management-System/Spring-Backend/images/";
...
//    }
    ...
    private String saveImageToFrontend(MultipartFile imageFile){
        ...
        String uniqueFileName = UUID.randomUUID() + "_" + imageFile.getOriginalFilename();
        String imagePath = imageStoragePath + uniqueFileName;
